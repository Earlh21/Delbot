...
namespace PayPalTest
{
	public static class PayPal
	{
		...
		static PayPal()
		{
			...
			CLIENT_SECRET = File.ReadAllText(CLIENT_SECRET_PATH).Replace(" ", "").Replace(Environment.NewLine, "");
		}
		...
		public static async Task<CreateOrderResponse> CreateOrderAsync(int amount, decimal price)
		{
